...
- [ ] The nine-phase execution protocol is defined in one prompt file (`execute.md`). No other prompt file or Go code embeds a competing definition of the phases.
