...
│   ├── review/              # Audit review batch I/O and types
│   ├── state/               # State types, I/O, mutations, navigation, propagation
...
- `daemon` → `config`, `inbox`, `invoke`, `logging`, `output`, `pipeline`, `state`, `tree`
