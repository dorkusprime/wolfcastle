...
58 ADRs documenting every major design choice. Each records the context, decision, and consequences so future contributors understand why the system is built the way it is. ADRs are the authoritative source; specs defer to them on conflict.
