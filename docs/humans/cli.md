...
| **Navigation**    | [`navigate`](cli/navigate.md), [`describe`](cli/describe.md)                                                                                                                                                                                                                            |
...
3. `git config core.hooksPath .githooks` to activate the pre-commit hook (gofmt only; CI handles vet, build, and lint via branch protection).
