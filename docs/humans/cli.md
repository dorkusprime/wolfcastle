...
| **Audit**         | [`audit run`](cli/audit-run.md), [`audit list`](cli/audit-run.md), [`audit show`](cli/audit-show.md), [`audit scope`](cli/audit-scope.md), [`audit breadcrumb`](cli/audit-breadcrumb.md), [`audit gap`](cli/audit-gap.md), [`audit fix-gap`](cli/audit-fix-gap.md), [`audit escalate`](cli/audit-escalate.md), [`audit resolve`](cli/audit-resolve.md), [`audit pending`](cli/audit-pending.md), [`audit approve`](cli/audit-approve.md), [`audit reject`](cli/audit-reject.md), [`audit history`](cli/audit-history.md) |
