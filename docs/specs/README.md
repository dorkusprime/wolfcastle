...
| [Config Schema](2026-03-12T00-01Z-config-schema.md) | Full JSON schema for config.json and config.local.json with defaults, merge semantics, doctor and overlap advisory |
...
| [CLI Commands](2026-03-12T00-06Z-cli-commands.md) | Detailed spec for all 21 commands including doctor, install, status --all |
