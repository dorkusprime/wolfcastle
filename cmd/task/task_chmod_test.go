...
func TestTaskClaim_SaveNodeStateError_ReadOnly(t *testing.T) {
	...
	env.RootCmd.SetArgs([]string{"task", "claim", "--node", "claim-proj/task-1"})
	err := env.RootCmd.Execute()
	if err == nil {
...
func TestTaskComplete_SaveNodeStateError_ReadOnly(t *testing.T) {
	...
	env.RootCmd.SetArgs([]string{"task", "claim", "--node", "complete-proj/task-1"})
	_ = env.RootCmd.Execute()
	...
	env.RootCmd.SetArgs([]string{"task", "complete", "--node", "complete-proj/task-1"})
	err := env.RootCmd.Execute()
	if err == nil {
...
func TestTaskBlock_SaveNodeStateError_ReadOnly(t *testing.T) {
	...
	_ = env.RootCmd.Execute()
	env.RootCmd.SetArgs([]string{"task", "claim", "--node", "block-proj/task-1"})
	_ = env.RootCmd.Execute()
	...
	env.RootCmd.SetArgs([]string{"task", "block", "--node", "block-proj/task-1", "stuck"})
	err := env.RootCmd.Execute()
	if err == nil {
...
func TestTaskUnblock_SaveNodeStateError_ReadOnly(t *testing.T) {
	...
	_ = env.RootCmd.Execute()
	env.RootCmd.SetArgs([]string{"task", "claim", "--node", "unblock-proj/task-1"})
	_ = env.RootCmd.Execute()
	env.RootCmd.SetArgs([]string{"task", "block", "--node", "unblock-proj/task-1", "blocked reason"})
	_ = env.RootCmd.Execute()
	...
	env.RootCmd.SetArgs([]string{"task", "unblock", "--node", "unblock-proj/task-1"})
	err := env.RootCmd.Execute()
	if err == nil {
