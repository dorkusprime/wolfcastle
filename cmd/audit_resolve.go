...
var auditResolveCmd = &cobra.Command{
...
func init() {
	auditResolveCmd.Flags().String("node", "", "Target node address (required)")
	auditResolveCmd.MarkFlagRequired("node")
	auditCmd.AddCommand(auditResolveCmd)
}
