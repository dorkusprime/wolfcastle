...
var auditScopeCmd = &cobra.Command{
	Use:   "scope",
...
func init() {
	auditScopeCmd.Flags().String("node", "", "Target node address (required)")
	auditScopeCmd.MarkFlagRequired("node")
	auditScopeCmd.Flags().String("description", "", "Audit scope description")
	auditScopeCmd.Flags().String("files", "", "Pipe-delimited list of files to audit")
	auditScopeCmd.Flags().String("systems", "", "Pipe-delimited list of systems to audit")
	auditScopeCmd.Flags().String("criteria", "", "Pipe-delimited list of acceptance criteria")
	auditCmd.AddCommand(auditScopeCmd)
}
