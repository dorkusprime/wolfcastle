...
// ═══════════════════════════════════════════════════════════════════════════
// scaffold.go — ReScaffold: invalid JSON in config.local.json
// ═══════════════════════════════════════════════════════════════════════════
...
func TestReScaffold_InvalidJSONInLocalConfig(t *testing.T) {
	...
	// Now corrupt config.local.json with invalid JSON
	...
	err := ReScaffold(dir)
	if err == nil {
		t.Fatal("expected error when config.local.json contains invalid JSON")
	}
